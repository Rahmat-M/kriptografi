document.getElementById('encryptForm').addEventListener('submit', function(event) {
    ...
    let sBoxLength = parseInt(document.getElementById('sBoxLength').value); // Menambahkan baris untuk mengambil panjang s-box
    console.log("Plain Text:", plainText);
    console.log("Key:", key);
    let rc4Instance = RC4(key, sBoxLength); // Membuat instance objek RC4 dengan panjang s-box yang ditentukan
...
document.getElementById('decryptForm').addEventListener('submit', function(event) {
    ...
    let rc4Instance = RC4(decryptionKey, sBoxLength); // Membuat instance objek RC4 dengan panjang s-box yang ditentukan
